...
file_to_save = os.path.join("analysis", "election_results_ch3.txt")

# Initialize counter.
total_votes = 0
# Initialize candidate options list and counties list
candidate_options = []
counties_options = []

# Declare an empty dictionary for candidate and counties list.
candidate_votes = {}
counties_votes = {}

# Winning Candidate,total Count and percentage for both candidates and counties
winning_candidate = ""
...
with open(file_to_save, "w") as txt_file:
    ...
    # Calculate the percentage of votes for each countie by looping through the counts.
    # Loop through the countie list.
    for county in counties_votes:
        ...
        # Print out each countie's name, counts and percentage of votes.
        counties_results = (
        ...
        # Calculate winning vote count and countie
        # Calculate if the votes are greater than the winning count.
    ...
    # Calculate the percentage of votes for each candidate by looping through the counts.
    ...
    for candidate in candidate_votes:
        ...
        # Print out each candidate's name, counts and percentage of votes to the terminal.
